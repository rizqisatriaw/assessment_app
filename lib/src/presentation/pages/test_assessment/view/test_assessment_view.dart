...
class TestAssessmentView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: GetBuilder<TestAssessmentController>(
          builder: (controller) {
            return Container(
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Obx(
                            () => controller.currentQuestion.options!.isNotEmpty
                                ? ListView.builder(
